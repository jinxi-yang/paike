        ...
        if override_date:
            try:
                ...
                assignments.append({
                    ...
                    'display_topic_name': f'开班仪式+{next_topic.name}' if next_topic.sequence == 1 else (f'结业典礼+{next_topic.name}' if next_topic.sequence == len(all_topics) else next_topic.name),
